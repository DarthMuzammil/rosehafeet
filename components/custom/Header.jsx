            ...
            {['Home', 'Services', 'About', 'Contact'].map((item) => (
              <div key={item} className="flex flex-col">
                <a
                  ...
                  className="relative text-[22px] text-gray-500 font-semibold hover:leading-[33px] hover:bg-gradient-to-r  hover:from-[#2A3676] hover:to-[#00A445] hover:bg-clip-text hover:text-transparent hover:opacity-90 group"
                >
                  {item}
